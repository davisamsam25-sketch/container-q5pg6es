...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-q5pg6es.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-q5pg6es.containers.anotherwebservice.com/
...
```
git clone git@github.com:davisamsam25-sketch/container-q5pg6es.git
cd container-q5pg6es
```
...
```
docker attach container-q5pg6es
```
